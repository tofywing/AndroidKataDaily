...
import review.android.androidkata_0.manager.ScreenAppearanceManager;
import review.android.androidkata_0.model.Movie;
import review.android.androidkata_0.model.MoviesLab;
import review.android.androidkata_0.service.KataService;
...
public class KataActivity extends AppCompatActivity {
    public static final String TAG = "KataActivity";
...
//        }
        ...
        mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                mMovies = intent.getParcelableArrayListExtra(KataService.DATA);
                createFragment();
                mDialog.dismiss();
            }
        };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_map) {
            Intent intent = new Intent(KataActivity.this, MapPane.class);
    ...
    protected void onStart() {
        super.onStart();
        IntentFilter intentFilter = new IntentFilter(KataService.SUCCESS);
    ...
    private void startFetchService(String input) {
        showProgressDialog();
        Intent intent = KataService.newIntent(getApplicationContext());
    ...
    private void showProgressDialog() {
        ...
        mDialog.setButton(DialogInterface.BUTTON_NEGATIVE, getString(R.string.progress_dialog_cancel), new
                DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = KataService.newIntent(KataActivity.this);
                        stopService(intent);
                        dialog.dismiss();
                    }
                });
